...
graph TD
    ...
    data["data（永続化層）<br/>ShortcutRepository / SettingsRepository<br/>MemoRepository / CalendarRepository<br/>DefaultLayoutConfig"]
    model["model（純粋ドメイン核・Android非依存）<br/>ShortcutModel / LayoutModel / LayoutState<br/>PremiumModel / MemoModel<br/>ShortcutTypeRules / LinkShortcutRules"]
